  ...
  return (
    <div className="max-w-3xl mx-auto px-5 py-10">
      <div className="mb-8">
        ...
        <p className="text-sm text-neutral-400">{articles.length}件の記事</p>
      </div>
      ...
      <div className="flex flex-wrap gap-2 mb-8 pb-8 border-b border-neutral-200">
        {categories.map((cat) => (
          <Link
            ...
            className={`text-[11px] font-semibold px-2.5 py-1 transition-opacity hover:opacity-70 ${cat.color}`}
          >
            {cat.name}
          </Link>
        ))}
