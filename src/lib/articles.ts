...
AIは、考えることを代わりにやらせる道具ではなく、考える準備と見直しを助ける道具として使うのが安全です。
  ...
  },
  {
    ...
    title: "ESを書く前にAIで自己PR・ガクチカの材料を整理する方法",
    description:
      "ESを書いたことがない大学3年生向けに、ChatGPTで自分の強み、経験の深掘り、ガクチカ構成、志望動機の方向性を整理する方法を紹介します。",
    category: "career",
...
最後は必ず自分の言葉に戻し、面接で聞かれても説明できる内容に整えることが大切です。
  ...
  },
  {
    ...
    title: "AIで面接対策する方法: 想定質問と深掘り練習のやり方",
    description:
      "就活面接の準備でChatGPTを使う方法を解説。自己PR、ガクチカ、志望動機の想定質問と深掘り質問を出してもらい、回答を磨くプロンプトを紹介します。",
    category: "career",
...
面接対策は、自己PRやガクチカを作って終わりではありません。

本番では、書いた内容に対して「なぜそうしたのか」「具体的に何をしたのか」「そこから何を学んだのか」と深掘りされます。
...
この記事では、ChatGPTを使って想定質問を出す方法、回答の弱い部分を見つける方法、本番前に自分の言葉へ戻す手順を紹介します。

## この記事はこんな人向け

- 就活面接で何を聞かれるか不安
- 自己PRやガクチカの深掘り質問を練習したい
- 志望動機の説得力をAIに確認してほしい
- 友達やキャリアセンターに相談する前に一人で練習したい
- AIの回答を暗記せず、自分の言葉で話せるようにしたい
...
AIで面接対策をするなら、回答を作らせるより、質問を出してもらう使い方が向いています。

自己PR、ガクチカ、志望動機をAIに読ませて、深掘り質問や弱い部分を出してもらうと、本番前に準備不足を見つけやすくなります。

ただし、AIが整えた文章をそのまま暗記するのは危険です。最後は声に出して読み、自分の経験と話し方に合う言葉へ戻してから面接練習に使いましょう。
    `,
  },
];
